...
struct LevelDataHelper {
    ...
    static let addCommand = CommandData.add(memoryIndex: 0)
    static let copyToCommand = CommandData.copyTo(memoryIndex: 0)
    static let copyFromCommand = CommandData.copyFrom(memoryIndex: 0)
